...
- Run: `FRUN-20260624-104617`
- Seed: `20260624`
- Surface scan: `SCAN-20260624-104618`
- Data path scan: `DPATH-20260624-104621`
- Paths selected: 200
- Stop reason: `path_limit_reached`
- Data path summary: `{'total': 2367, 'dead': 182, 'unresolved': 546, 'completed': 1639, 'hazard_count': 3369}`
...
- `data.environment.packages.jinn.dist.src.engines.claude-interactive.d.ts.Build_the_env_passed_to_the_claude_PTY_inherits_process_env_` shell_exec severity=high line=165 file=`packages/jinn/dist/src/engines/claude-interactive.d.ts` evidence='*  enables fullscreen rendering. Shared by spawn() and ensureIdleSpawn().'
- `data.environment.packages.jinn.dist.src.engines.claude-interactive.d.ts.Build_the_env_passed_to_the_claude_PTY_inherits_process_env_` shell_exec severity=high line=172 file=`packages/jinn/dist/src/engines/claude-interactive.d.ts` evidence='*  the live active entry here rather than capturing onStream at spawn.'
- `data.environment.packages.jinn.dist.src.engines.claude-interactive.js.Build_the_env_passed_to_the_claude_PTY_inherits_process_env_` shell_exec severity=high line=856 file=`packages/jinn/dist/src/engines/claude-interactive.js` evidence='*  enables fullscreen rendering. Shared by spawn() and ensureIdleSpawn().'
