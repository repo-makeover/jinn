...
- Run: `FRUN-20260625-171136`
- Seed: `20260625`
- Surface scan: `SCAN-20260625-171138`
- Data path scan: `DPATH-20260625-171143`
- Paths selected: 4
...
- `cli.argparse.kokoro_sidecar` (cli_command) score=0.25 weight=2.5 diff=changed variant=1 strategy=baseline file=`packages/jinn/src/talk/kokoro_sidecar.py`
